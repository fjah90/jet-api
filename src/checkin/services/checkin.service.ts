...
import { CreateCheckinDto, GetBoardingPassDto, PostSendEmailDto } from '../dto/index';
...
export class CheckinService {
  ...
  async createCheckin(createCheckinDto: CreateCheckinDto, firebaseToken: string, user: string): Promise<HttpException> {
    try {
  ...
  public async getBoardinPass(
    getBoardingPassDto: GetBoardingPassDto,
