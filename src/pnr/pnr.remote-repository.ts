...
export class PnrRemoteRepository {
  private logger = new JsonLogger(PnrRemoteRepository.name);
  ...
  public async summaryPnr(request: SummaryPnrRequest, token, user: string) {
